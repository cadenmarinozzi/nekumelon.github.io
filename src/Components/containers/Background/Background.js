...
void main( )
{
    ...
    vec2 p = (2.0*uv-uResolution.xy)/uResolution.y;
    ...
    gl_FragColor = render( ro, rd, ivec2(uv-0.5) );
}
`;
const vertexShader = `
varying vec2 vUv;
...
class Background extends Component {
	...
	// 	const noiseTexture2 = textureLoader.load('/assets/noise1.png');
	...
	render() {
		// return <div className='background' ref={this.backgroundRef} />;
		return;
	}
}
